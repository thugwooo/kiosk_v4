...
var health_info_text_list = [
  ...
  '항산화 물질이 풍부한 원료가 포함되어 있어 면역력과 노화예방에 도움이 됩니다.',
];
var skin_care = ['청어', '연어', '가자미', '고등어', '정어리', '볼락', '대구', '솔 피쉬', 'Chia seed', '당근', '야자유', '아마', '송어'];
var bone_care = ['상어연골', '강황', '글루코사민', '콘드로이틴', 'MSM', '식이유황', '초록입홍합', '뉴질랜드 녹색홍합', '로즈힙', '아스코르브산', '비타민C', 'L-아스코르빌-2-폴리인산'];
var digest_care = [
  '석류',
  '배추',
  '양배추',
...
var diet_care = ['가자미', '볼락', 'L-카르니틴', '코코넛', '녹차추출물', '그린티추출물'];
var alg_care = [];
var antioxidant_care = ['고등어', '석류', '당근', '배추', '양배추', '땅콩호박', '비타민E', 'Vitamin E', '베타카로틴', '아스코르브산', '비타민C', '녹차추출물', '그린티추출물', 'L-아스코르빌-2-폴리인산', '로즈마리'];
var dog_breed = [
  '소형견 믹스',
  '중형견 믹스',
  '대형견 믹스',
